      ...
      <section>
        {text === 'terms' ? (
          <>
            <p>Privacy Policy</p>
            <p>
              When you use our player <b>{radio?.name}</b> you’re trusting us
            ...
            <p>
              ...
              find most useful, or which music and audio files you might like.
            ...
            <p>
              ...
              use, which helps us provide features like automatic product
              updates.
            </p>
            <p>
            ...
            <p>
              We collect this information when you are using our services and
              apps on your device contacts our servers. This information
              includes things like your device type, carrier name, crash
              reports, and which apps you've installed.
            </p>
            <p>
              We collect information about your activity in our players, which
              we use to do things like recommend music you might like. The
              activity information we collect may include: views and
              interactions with content and ads, audios you are listening to.
            </p>
            <p>
              We use the information we collect to customize our services for
              you, including providing recommendations, personalized content,
              and ads.
            </p>
            <p>
            ...
            <p>
              ...
              you with things like personalized ads, or other features tailored
              to how you use our players. And we analyze your content to help us
              detect abuse such as spam, malware, and illegal content. We also
              use algorithms to recognize patterns in data.
            </p>
            <p>
          ...
          <>
            ...
            <p>
              ...
              individual or entity using the Player (and/or any individual,
              agent, employee, representative, network, parent, subsidiary,
              affiliate, successor, related entities, assigns, or all other
              individuals or entities acting on your behalf), at your direction,
              under your control, or under the direction or control of the same
              individual or entity who controls you. "We," "us" means{' '}
              <b>{radio?.name}</b> Player, and the "parties" means you and us.
            </p>
            <p>2. Access to the Player</p>
            <p>
              While you are using our Player you agree with this Terms. We have
              the right to refuse or limit your access to the Player. In order
              to verify your person, from time-to-time we may ask for additional
              information from you, including, but not limited to, verification
              of your name, address, and other identifying information.
            </p>
            <p>
              By using the Player, you permit to serve, as applicable,
              advertisements and other content ("Ads"), mobile applications,
              media players, mobile content, and/or other properties approved by
              us (each individually a "Property"). In addition, you grant us the
              right to access, index and cache the Properties, or any portion
              thereof, including by automated means. We may refuse to provide
              the Services to any Property.
            </p>
            <p>
              Any Property that is a software application and accesses our
              Player may require preapproval by us in writing.
            </p>
            ...
            <p>
              ...
              interfere with our Player or try to access them using a method
            ...
            <p>
              ...
              remove functionalities or features of the Player at any time, and
              we may suspend or stop a Player altogether.
            </p>
            <p>
              We may modify the Terms at any time. We'll post any modifications
              to the Terms on this page and any modifications to the Policies.
              ...
              you don't agree to any modified terms in the Terms, you'll have to
              stop using the affected Player.
            </p>
            ...
            <p>
              If we provides you the Player, we don’t grant you any sublicense
              or license for use of such software.
            </p>
            <p>
              This is purpose of enabling you to use and enjoy the benefit of
              the Player as provided by us, in the manner permitted by the
              Terms.
            </p>
            <p>
            ...
            <p>
              ...
              Terms. We may revoke this license at any time. Any goodwill
              arising from your use of our Brand Features will belong to us.
            </p>
            <p>
